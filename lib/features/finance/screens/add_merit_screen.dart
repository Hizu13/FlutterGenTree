...
class AddMeritScreen extends StatefulWidget {
  const AddMeritScreen({super.key});
...
class _AddMeritScreenState extends State<AddMeritScreen> {
  final _eventController = TextEditingController(
    text: 'Công đức tu bổ nhà thờ',
  );
  final _amountController = TextEditingController(text: '1.000.000');
  final _noteController = TextEditingController();

  String _selectedSource = 'Lê Thị F';
  DateTime _selectedDate = DateTime(2024, 4, 24);
  bool _requiresApproval = true;

  final List<String> _sources = ['Lê Thị F', 'Phạm Văn H', 'Nguyễn Thị K'];
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Đã ghi nhận khoản công đức thành công!'),
                    ),
                  );
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2),
                Text(
                  'Khoản công đức này sẽ được gửi đến người có thẩm quyền phê duyệt trước khi ghi nhận.',
                  style: TextStyle(
