...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  final _eventController = TextEditingController(text: 'Mua vật tư xây dựng');
  final _amountController = TextEditingController(text: '1.200.000');
  final _noteController = TextEditingController();

  String _selectedSource = 'Trần Văn B';
  DateTime _selectedDate = DateTime(2024, 4, 29);
  bool _requiresApproval = true;

  final List<String> _sources = ['Trần Văn B', 'Nguyễn Văn A', 'Ban tổ chức'];
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Đã gửi yêu cầu phê duyệt khoản chi thành công!',
                      ),
                    ),
                  );
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2),
                Text(
                  'Khoản chi này sẽ được gửi đến người có thẩm quyền phê duyệt trước khi ghi nhận.',
                  style: TextStyle(
